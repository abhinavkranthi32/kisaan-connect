...
var currentLang = 'te'; // Default to Telugu as requested
...
const TRANSLATIONS = {
  te: {
    ...
    btn_instant_login: '⚡ తక్షణ రైతు లాగిన్ (Instant Login) →',
  ...
  en: {
    ...
    btn_instant_login: '⚡ Instant Farmer Login (Skip OTP) →',
...
function setLanguage(lang) {
  ...
  if (lang === 'en') {
    ...
    if (btnTe) btnTe.classList.remove('active');
  } else {
    document.body.classList.remove('lang-en');
    if (btnTe) btnTe.classList.add('active');
